 ...
 * @author ASUS
 */
public class defec extends javax.swing.JFrame {

    int xx,xy;
    /**
     * Creates new form defec
     */
    public defec() {
        initComponents();
        ...
        */
        ...
        for (int i = 0; i < name.length(); i++) {
            ...
            if (!Character.isDigit(c)) {
                JOptionPane.showMessageDialog(rootPane,"Enter Numbers Only in the 'Total amount' Field");
                return false;
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Defectve details");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try{
            ...
            String sql = "SELECT date,reference_id,user,defective_item,payment,total_amount,status,notes FROM maintain_def WHERE date='" + datebox.getDate() + "'";
        ...
        if (x == 0){
            ...
            try{
                ...
                if(isValidName(def.getText()) == !false && isValidNumber(tot.getText()) == !false && combobox() == !false && combobox2() == !false && combobox3() == !false && ref() == !false && amunt() == !false && def() == !false){
                    ...
                    s.executeUpdate("INSERT INTO maintain_def (date,reference_id,user,defective_item,payment,total_amount,status,notes) VALUES ('"+ date +"','"+ ref.getText() +"','"+ jComboBox1.getSelectedItem() +"','" + def.getText() + "','" + jComboBox3.getSelectedItem() + "','" + tot.getText() +"','"+ jComboBox4.getSelectedItem() +"','"+ note.getText() + "')");
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        Connection c = DB.mycon();
        Statement s = c.createStatement();
        ResultSet rs = s.executeQuery("SELECT date,reference_id,user,defective_item,payment,total_amount,status,notes FROM maintain_def");
        Document document = new Document();
        PdfWriter.getInstance(document, new FileOutputStream("Defective_Report.pdf"));
        document.open();          
        document.add(new Paragraph("Defective Details",FontFactory.getFont(FontFactory.TIMES_BOLD,16,Font.BOLD)));
        document.add(new Paragraph("  "));
        document.add(new Paragraph(new Date().toString()));
        document.add(new Paragraph("The following report shows the defective details in Rajapura Wedhamadura"));
        document.add(new Paragraph("____________________________________________________________________________"));
        document.add(new Paragraph("   "));
        PdfPTable table = new PdfPTable(8);
        table.setWidthPercentage(105);
        PdfPCell cell=new PdfPCell(new Paragraph("Defective Details"));
        cell.setColspan(8);
        ...
        table.addCell(cell3);
        PdfPCell cell4=new PdfPCell(new Paragraph("defective type"));
        ...
        table.addCell(cell7);
        PdfPCell cell8=new PdfPCell(new Paragraph("notes"));
        cell7.setBackgroundColor(BaseColor.LIGHT_GRAY);
        table.addCell(cell8);
...
//        
        ...
        while (rs.next()) {
            ...
            exp1 = (rs.getString("defective_item"));
        ...
        if (x==0){
            try{
               ...
               Desktop.getDesktop().open(new File("C:/Users/KALINDU/Documents/NetBeansProjects/ManagementSystem/Defective_Report.pdf"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(defec.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
