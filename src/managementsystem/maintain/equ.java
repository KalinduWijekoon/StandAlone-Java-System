 ...
 * @author ASUS
 */
public class equ extends javax.swing.JFrame {
    ...
    private void initComponents() {
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(jButton10, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 231, Short.MAX_VALUE)
        ...
        jLabel8.setText("Equipment details");
        ...
        jPanel14Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel14Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(datebox, javax.swing.GroupLayout.PREFERRED_SIZE, 158, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(34, 34, 34)
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try{
            ...
            String sql = "SELECT date,reference_id,user,equip_type,payment,amount,VAT,total_amount,status,notes FROM maintain_equip WHERE date='" + datebox.getDate() + "'";
        ...
        if (x == 0){
            ...
            try{
                ...
                if(isValidName(equip.getText()) ==  !false && isValidNumber(amunt.getText()) == !false && isValidNumber1(vat.getText()) == !false && combobox() == !false && combobox2() == !false && combobox3() == !false && ref() == !false && amunt() == !false && equip() == !false){
                    ...
                    s.executeUpdate("INSERT INTO maintain_equip (date,reference_id,user,equip_type,payment,amount,VAT,total_amount,status,notes) VALUES ('"+ date +"','"+ ref.getText() +"','"+ jComboBox1.getSelectedItem() +"','" + equip.getText() + "','" + jComboBox3.getSelectedItem() + "','" + amunt.getText() +"','" + vat.getText() + "','" + totamunt.getText() +"','"+ jComboBox4.getSelectedItem() +"','"+ note.getText() + "')");
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        Connection c = DB.mycon();
        Statement s = c.createStatement();
        ResultSet rs = s.executeQuery("SELECT date,reference_id,user,equip_type,payment,amount,VAT,total_amount,status,notes FROM maintain_equip");
        Document document = new Document();
        PdfWriter.getInstance(document, new FileOutputStream("Equipment_Report.pdf"));
        document.open();          
        document.add(new Paragraph("Equipment Details",FontFactory.getFont(FontFactory.TIMES_BOLD,16,Font.BOLD)));
        document.add(new Paragraph("  "));
        document.add(new Paragraph(new Date().toString()));
        document.add(new Paragraph("The following report shows the equipment details in Rajapura Wedhamadura"));
        document.add(new Paragraph("____________________________________________________________________________"));
        document.add(new Paragraph("   "));
        PdfPTable table = new PdfPTable(10);
        table.setWidthPercentage(105);
        PdfPCell cell=new PdfPCell(new Paragraph("Equipment Details"));
        cell.setColspan(10);
        ...
        table.addCell(cell3);
        PdfPCell cell4=new PdfPCell(new Paragraph("equipment type"));
...
//        
        ...
        if (x==0){
            try{
               ...
               Desktop.getDesktop().open(new File("C:/Users/KALINDU/Documents/NetBeansProjects/ManagementSystem/Equipment_Report.pdf"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(equ.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
